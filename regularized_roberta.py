...
class RegularizedRobertaForQuestionAnswering(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.config.output_dropout_prob > 0:
            self.output_dropout = nn.Dropout(p=config.output_dropout_prob)
